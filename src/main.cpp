...
int64 nChainStartTime = 1400233104;
...
const string strMessageMagic = "Ascentcoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Ascentcoin
    bool fStrictPayToScriptHash = true; // Always active in Ascentcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ascentcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1400233104";
        CTransaction txNew;
       ...
       if ( false  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("bd9d01127cf5afafd61ca7a69771a4b8bd3acc020def5a949643fd79ec60eeb1"));
...
// The characters are rarely used upper ASCEII, not valid as UTF-8, and produce
